...
public class NoSSLv3SocketFactory extends SSLSocketFactory {
    ...
    private class NoSSLv3SSLSocket extends DelegateSSLSocket {
        ...
        public void setEnabledProtocols(String[] protocols) {
            if (protocols != null) {
                ...
                Log.d(TAG, "SSL Enabled Protocols: " + String.valueOf(enabledProtocols));
    ...
    public class DelegateSSLSocket extends SSLSocket {
        ...
        public byte[] getNpnSelectedProtocol() {
            return (byte[]) GET_NPN_SELECTED_PROTOCOL.invokeWithoutCheckedException(delegate);
        }

        public byte[] getAlpnSelectedProtocol() {
            return (byte[]) GET_ALPN_SELECTED_PROTOCOL.invokeWithoutCheckedException(delegate);
        }

        public void setUseSessionTickets(Boolean val) {
            SET_USE_SESSION_TICKETS.invokeOptionalWithoutCheckedException(delegate, val);
        }

        public void setHostname(String val) {
            SET_HOSTNAME.invokeOptionalWithoutCheckedException(delegate, val);
        }

        public void setAlpnProtocols(byte[] val) {
            SET_ALPN_PROTOCOLS.invokeWithoutCheckedException(delegate, val);
        }

        public void setNpnProtocols(byte[] val) {
            SET_NPN_PROTOCOLS.invokeWithoutCheckedException(delegate, val);
        }
    }
}
