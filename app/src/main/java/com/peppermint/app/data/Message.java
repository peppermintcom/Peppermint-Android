...
public class Message {
    ...
    public Message(long mId, Chat mChat, Recording mRecording, Recipient mRecipient, String mEmailSubject, String mEmailBody, String mRegistrationTimestamp, boolean mSent, String mServerId, String mServerCanonicalUrl, String mServerShortUrl, String mServerTranscriptionUrl) {
        this.mId = mId;
        this.mChat = mChat;
