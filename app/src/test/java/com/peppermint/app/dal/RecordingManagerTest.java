...
public class RecordingManagerTest {
    ...
    public void testInsert() throws SQLException {
        ...
        RecordingManager.getInstance().insert(mDatabase, recording);
    ...
    public void testGetInsert() throws SQLException {
        Recording recording = RecordingManager.getInstance().getRecordingById(mDatabase, 1);
        ...
        recording = RecordingManager.getInstance().getRecordingById(mDatabase, 2);
        assertNotNull(recording);
    ...
    public void testUpdate() throws SQLException {
        ...
        recording.setId(1);
        RecordingManager.getInstance().update(mDatabase, recording);
    ...
    public void testInsertOrUpdate() throws SQLException {
        ...
        RecordingManager.getInstance().insertOrUpdate(mDatabase, recording);
